...
```text
Remote MCP memory server that gives AI assistants project context, initiatives, tasks, source events, and durable facts across WorkDrive, D1, Vectorize, GitHub, and live business tools.
```
