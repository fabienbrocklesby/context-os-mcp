...
const DEFAULT_ENV_CAPS: EnvironmentCapability[] = [
  ...
  makeEnvCap("codex", "zoho_crm_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 32),
  makeEnvCap("codex", "zoho_mail_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 33),
  makeEnvCap("codex", "calendar_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 34),
  ...
  makeEnvCap("claude", "zoho_crm_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 20),
  makeEnvCap("claude", "zoho_mail_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 21),
  makeEnvCap("claude", "calendar_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 22),
  makeEnvCap("chatgpt", "contextos_memory", "available", "mcp_tool", "prepare_assistant_session", 10),
  makeEnvCap("chatgpt", "zoho_crm_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 20),
  makeEnvCap("chatgpt", "zoho_mail_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 21),
  makeEnvCap("chatgpt", "calendar_live", "user_configured", "connector", "LightLane-ReadOnly Zoho MCP", 22),
  makeEnvCap("generic_mcp", "contextos_memory", "available", "mcp_tool", "prepare_assistant_session", 10),
  makeEnvCap("generic_mcp", "zoho_crm_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 20),
  makeEnvCap("generic_mcp", "zoho_mail_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 21),
  makeEnvCap("generic_mcp", "calendar_live", "user_configured", "mcp_tool", "LightLane-ReadOnly Zoho MCP", 22),
